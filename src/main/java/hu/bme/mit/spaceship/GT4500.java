...
public class GT4500 implements SpaceShip {
  ...
  public boolean tryPrimaryFirst(){
  ...
  public boolean trySecondaryFirst(){
      boolean firingSuccess = false;
  ...
  */
  ...
  public boolean fireTorpedos(FiringMode firingMode) {
    ...
    switch (firingMode) {
      case SINGLE:
        if (wasPrimaryFiredLast)  firingSuccess = trySecondaryFirst();
        else firingSuccess = tryPrimaryFirst();
        break;
